...
var greetUser = function (name, age) {
    if (age !== undefined) {
        return "\u3053\u3093\u306B\u3061\u306F\u3001".concat(name, "\u3055\u3093\uFF08").concat(age, "\u6B73\uFF09\uFF01");
    }
...
// 4. ログを出力する関数（戻り値なし）
function logMessage(message) {
    console.log("[LOG] ".concat(new Date().toISOString(), ": ").concat(message));
}
// ======================================
// 【使用例・テスト】
// ======================================
...
var area2 = calculateArea(7.5, 4.2);
console.log("\u9762\u7A4D1: ".concat(area1, "\u5E73\u65B9\u30E1\u30FC\u30C8\u30EB"));
console.log("\u9762\u7A4D2: ".concat(area2, "\u5E73\u65B9\u30E1\u30FC\u30C8\u30EB"));
// greetUser関数のテスト
...
var total = calculateSum(scores);
console.log("\u30B9\u30B3\u30A2\u5408\u8A08: ".concat(total, ", \u5E73\u5747: ").concat(total / scores.length));
// logMessage関数のテスト
...
// 1. デフォルト引数を持つ関数
function createMessage(name, prefix) {
    if (prefix === void 0) { prefix = "様"; }
    return "".concat(name).concat(prefix, "\u3001\u304A\u75B2\u308C\u69D8\u3067\u3059");
}
...
console.log("parseInput(\"123\"): ".concat(parseInput("123")));
console.log("parseInput(\"hello\"): ".concat(parseInput("hello")));
var doubled = processArray([1, 2, 3, 4, 5], function (x) { return x * 2; });
console.log("2\u500D\u306B\u3057\u305F\u914D\u5217: [".concat(doubled.join(", "), "]"));
